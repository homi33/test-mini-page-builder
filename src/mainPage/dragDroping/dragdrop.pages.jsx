...
import { selectCurrentSavedState } from "../../redux/state/state.selector";
import { setCurrentSavedState } from "../../redux/state/state.actions";
...
class DragDropPage extends Component {
  ...
  handleOk = () => {
    ...
    if (
      modalName.trim() !== "" &&
      String(modalFontSize).trim() !== "" &&
      String(modalFontWeight) !== ""
    ) {
      this.setState(
        {
          modalVisible: false,
  ...
  onDrop = (ev, cat) => {
    ...
    let placed = null;
    let { counter, inputValues, modalName, modalFontSize, modalFontWeight } =
      this.state;
    counter++;
  ...
  render() {
    ...
    return (
      <div
        className="drag-drop-page"
        onKeyDown={(e) => this.handleDelete(e)}
        tabIndex="0"
      >
        <div className="container-drag">
          ...
          >
            <h2>Blocks</h2>
            <div
              onDragStart={(e) => this.onDragStart(e, "label")}
              draggable
              className="draggable"
            >
            ...
            <div
              onDragStart={(e) => this.onDragStart(e, "input")}
              draggable
              className="draggable"
            >
              <AppstoreOutlined style={{ marginRight: 8, color: "#D4D4D4" }} />
            ...
            <div
              onDragStart={(e) => this.onDragStart(e, "button")}
              draggable
              className="draggable"
            >
              <AppstoreOutlined style={{ marginRight: 8, color: "#D4D4D4" }} />
